...
from imle.aimle_to_reinforce import aimle
...
def main(argv):
    ...
    parser.add_argument("--method", "-M", type=str, choices=['gumbel-softmax', 'imle', 'aimle_to_reinforce', 'ste'], default='imle')
    ...
    for epoch in range(1, nb_epochs + 1):
        ...
        elif args.method in {'aimle_to_reinforce'}:
            noise_distribution = name_to_distribution(args.imle_noise)
        ...
        for X, _ in train_loader:
            ...
            storch.add_cost(loss, "reconstruction")
            cost = storch.backward()

            epoch_loss_values += [cost.item()]
        ...
        with torch.inference_mode():
            for X, _ in test_loader:
                ...
                test_loss += loss.detach_tensor().item() / nb_samples
